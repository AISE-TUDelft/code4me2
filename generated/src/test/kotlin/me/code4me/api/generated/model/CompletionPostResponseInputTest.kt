...
class CompletionPostResponseInputTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CompletionPostResponseInput
        //val modelInstance = CompletionPostResponseInput()

        // to test the property ``data`` - Generated code completions including query ID and suggestions
        should("test `data`") {
