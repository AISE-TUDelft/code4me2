...
class CreateUserPostResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreateUserPostResponse
        //val modelInstance = CreateUserPostResponse()

        // to test the property `userId` - Created user id
        should("test userId") {
