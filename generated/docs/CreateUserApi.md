...
| ------------- | ------------- | ------------- |
| [**createUserApiUserCreatePost**](CreateUserApi.md#createUserApiUserCreatePost) | **POST** /api/user/create/ | Create User |
...
try {
    ...
    println("4xx response calling CreateUserApi#createUserApiUserCreatePost")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CreateUserApi#createUserApiUserCreatePost")
    e.printStackTrace()
}
```
