...
| ------------- | ------------- | ------------- |
| [**deleteUserApiUserDeleteDelete**](DeleteApi.md#deleteUserApiUserDeleteDelete) | **DELETE** /api/user/delete/ | Delete User |
...
try {
    ...
    println("4xx response calling DeleteApi#deleteUserApiUserDeleteDelete")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DeleteApi#deleteUserApiUserDeleteDelete")
    e.printStackTrace()
}
```
