...
| ------------- | ------------- | ------------- |
| [**updateUserApiUserUpdatePut**](UpdateUserApi.md#updateUserApiUserUpdatePut) | **PUT** /api/user/update/ | Update User |
...
try {
    ...
    println("4xx response calling UpdateUserApi#updateUserApiUserUpdatePut")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling UpdateUserApi#updateUserApiUserUpdatePut")
    e.printStackTrace()
}
```
