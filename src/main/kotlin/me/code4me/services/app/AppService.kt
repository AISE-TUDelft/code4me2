...
class AppService {
     ...
     *        Expected to contain entries for [Record.Type.CONTEXT], [Record.Type.BEHAVIORALTELEMETRY] and [Record.Type.CONTEXTUALTELEMETRY]
     ...
     * @see Record.Type.BEHAVIORALTELEMETRY
     * @see Record.type.CONTEXTUALTELEMETRY
     */
