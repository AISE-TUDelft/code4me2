...
class AuthenticationSection : SettingsSection {
    ...
    private fun updateToggleText() {
        ...
        authModeToggle.text = if (isLoginMode) "Don't have an account? witch to Sign Up Mode" else "Already have an account? Switch to Login Mode"
    }
    ...
    override fun applyTo(builder: FormBuilder, stateValueFields: MutableList<StateValueField<*>>) {
        ...
        val topContentPanel = FormBuilder.createFormBuilder()
        ...
        val bottomContentPanel = FormBuilder.createFormBuilder()
    ...
    private fun performSignup(fullName: String, email: String, password: String): String? {
        // TODO : Actually make this call an api
        return "TEST_KEY"
    }
