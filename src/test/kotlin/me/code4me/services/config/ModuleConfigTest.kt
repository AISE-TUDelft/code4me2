...
class ModuleConfigTest {
    ...
    fun testModuleCategoryConfig() {
        ...
        val category = ModuleCategoryConfig(
            id = "test-category",
            path = "test/path",
        ...
        // Test equality
        val sameCategory = ModuleCategoryConfig(
            id = "test-category",
            path = "test/path",
            description = "Test Category Description"
        )
        ...
        // Test inequality
        val differentCategory = ModuleCategoryConfig(
    ...
    fun testModuleConfig() {
        ...
        // Test inequality
        val differentModule = ModuleConfig(
            id = "different-module",
            className = "me.code4me.TestModule",
            name = "Test Module",
            type = category,
        ...
        val disabledModule = ModuleConfig(
            id = "test-module",
            className = "me.code4me.TestModule",
            name = "Test Module",
            type = category,
