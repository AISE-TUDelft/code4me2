...
class ConfigurationSectionTest : BasePlatformTestCase() {
    ...
    fun testCreateConfigurationPanel() {
        val section = ConfigurationSection()
        val configPanel = section.javaClass.getDeclaredMethod("createConfigurationPanel").apply { isAccessible = true }.invoke(section) as JPanel
    ...
    fun testCreateApplicationPreferencesPanel() {
        val section = ConfigurationSection()
        val appPrefsPanel = section.javaClass.getDeclaredMethod("createApplicationPreferencesPanel").apply { isAccessible = true }.invoke(section) as JPanel
    ...
    fun testCreateModuleManagementPanel() {
        val section = ConfigurationSection()
        val modulePanel = section.javaClass.getDeclaredMethod("createModuleManagementPanel").apply { isAccessible = true }.invoke(section) as JPanel
    ...
    fun testCreateUserInfoPanel() {
        val section = ConfigurationSection()
        val userInfoPanel = section.javaClass.getDeclaredMethod("createUserInfoPanel").apply { isAccessible = true }.invoke(section) as JPanel
    ...
    fun testCreatePreferenceFields() {
        ...
        val booleanFieldMethod = section.javaClass.getDeclaredMethod("createBooleanField", String::class.java, me.code4me.utils.configuration.Preference::class.java)
            .apply { isAccessible = true }

        // Create a test preference using the correct constructor
        val booleanPref = me.code4me.utils.configuration.Preference(
            key = "test.bool",
        ...
        val stringFieldMethod = section.javaClass.getDeclaredMethod("createStringField", String::class.java, me.code4me.utils.configuration.Preference::class.java)
            .apply { isAccessible = true }

        val stringPref = me.code4me.utils.configuration.Preference(
            key = "test.string",
        ...
        val intFieldMethod = section.javaClass.getDeclaredMethod("createIntegerField", String::class.java, me.code4me.utils.configuration.Preference::class.java)
            .apply { isAccessible = true }

        val intPref = me.code4me.utils.configuration.Preference(
            key = "test.int",
        ...
        val floatFieldMethod = section.javaClass.getDeclaredMethod("createFloatField", String::class.java, me.code4me.utils.configuration.Preference::class.java)
            .apply { isAccessible = true }

        val floatPref = me.code4me.utils.configuration.Preference(
            key = "test.float",
    ...
    fun testValidateDecimalInput() {
        ...
        val validateMethod = section.javaClass.getDeclaredMethod(
    ...
    fun testCheckModuleCanBeDisabled() {
        ...
        val checkMethod = section.javaClass.getDeclaredMethod(
    ...
    fun testFindModuleNodeById() {
        ...
        val findMethod = section.javaClass.getDeclaredMethod(
            "findModuleNodeById",
            String::class.java,
    ...
    fun testBuildModulePreferencesUI() {
        ...
        val buildMethod = section.javaClass.getDeclaredMethod(
    ...
    fun testAddModuleHeader() {
        ...
        val addHeaderMethod = section.javaClass.getDeclaredMethod(
            "addModuleHeader",
            PluginModule::class.java
        ).apply { isAccessible = true }
    ...
    fun testAddModuleEnablementControl() {
        ...
        val addControlMethod = section.javaClass.getDeclaredMethod(
    ...
    fun testHandleModuleEnablementChange() {
        ...
        val handleMethod = section.javaClass.getDeclaredMethod(
    ...
    fun testEnableModuleWithDependencies() {
        ...
        val enableMethod = section.javaClass.getDeclaredMethod(
    ...
    fun testDisableModuleWithDependents() {
        ...
        val disableMethod = section.javaClass.getDeclaredMethod(
    ...
    fun testAddModulePreferences() {
        ...
        val addPrefsMethod = section.javaClass.getDeclaredMethod(
    ...
    fun testAddPreferenceField() {
        ...
        val addFieldMethod = section.javaClass.getDeclaredMethod(
            "addPreferenceField",
            PluginModule::class.java,
    ...
    fun testCreatePreferenceField() {
        ...
        val createFieldMethod = section.javaClass.getDeclaredMethod(
