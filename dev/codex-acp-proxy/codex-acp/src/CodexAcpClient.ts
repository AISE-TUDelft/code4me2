...
export class CodexAcpClient {
    ...
    constructor(
        ...
        // never calls authenticate() at all, making the authenticate() guard insufficient).
        const proxyUrl = process.env["CODEX_PROXY_URL"];
        this.gatewayConfig = proxyUrl
            ? {
